...
def test_get_single_record(db_connection):
    ...
    assert cohort == Cohort(1, "Feb 23", "2023-02-23")
...
def test_create_record(db_connection):
    ...
    repository.create(Cohort(None, "Mar 23", '2023-3-23'))

    result = repository.all()
    assert result == [
        Cohort(1, 'Feb 23', '2023-2-23'),
        Cohort(2, "Mar 23", "2023-03-23")
    ]
